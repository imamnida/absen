...
--
-- Host: localhost
-- Generation Time: Jan 13, 2024 at 04:18 PM
...
INSERT INTO `rfid` (`id_rfid`, `id_devices`, `nis`, `uid`, `id_kelas`, `nama`, `telp`, `gender`, `jabatan`, `alamat`, `foto`) VALUES
(1, 2, '21221007', 'a3-9b-5-fe-c3', 1, 'AGNIA PADILAH', '697696978', 'p', 'siswa', 'indonesia', 'https://drive.google.com/uc?export=view&id=1PkUs48tuQOfvoy1qNWtQUJmELMpKSX9o'),
(2, 2, '21221008', '53-a1-18-fe-14', 1, 'CITRA MULYANI', '697696978', 'p', 'siswa', 'indonesia', 'https://drive.google.com/uc?export=view&id=1TU5CrvOBNEfAb2munvPOuAMM4UADj4cW'),
(3, 2, '21221009', '73-fd-17-fe-67', 1, 'DHEA RAISYA AULLIA', '697696978', 'p', 'siswa', 'indonesia', 'https://drive.google.com/uc?export=view&id=1E_pSgVIntvfUF-9eeKIiMr_qxX4y4W89'),
(4, 2, '21221010', 'c3-c0-25-fe-d8', 1, 'DITA ANANDA', '697696978', 'p', 'siswa', 'indonesia', 'https://drive.google.com/uc?export=view&id=1Rh4X9a1BY1PjK-8uDlAFOi-nGxjzNP4F'),
(5, 2, '21221011', '43-30-a-fe-87', 1, 'EMELYA ANWAR', '697696978', 'p', 'siswa', 'indonesia', 'https://drive.google.com/uc?export=view&id=1cX8JUgAVHbafo6Aj61OmgV-uJbe0AODD'),
(6, 2, '21221012', 'e3-fa-b-fe-ec', 1, 'EPA LESTIYANI', '697696978', 'p', 'siswa', 'indonesia', 'https://drive.google.com/uc?export=view&id=1xzQUYVzM4N_GTtOY42mwNF5rBzGBFtV5'),
(7, 2, '21221013', '83-e-d-fe-7e', 1, 'FERA PETIKASARI', '697696978', 'p', 'siswa', 'indonesia', 'https://drive.google.com/uc?export=view&id=1fT5jSy25ybwZMQS0V2SDhkC9q0dpkWHZ'),
(8, 2, '21221014', '83-8-1a-fe-6f', 1, 'FIRNAWANTI AMALIA', '697696978', 'p', 'siswa', 'indonesia', 'https://drive.google.com/uc?export=view&id=16uKunYTylXF-ZwGStOWqkYJmiQyH6_rv'),
(9, 2, '21221015', 'e3-a9-11-fe-a5', 1, 'GEA AULIA PUTRI', '697696978', 'p', 'siswa', 'indonesia', 'https://drive.google.com/uc?export=view&id=12DZVRpf0kwSBNIbOZuiy4_3feg6bLFl9'),
(10, 2, '21221016', 'd3-6d-c-fe-4c', 1, 'HANI NURFITRI RAHMADANI', '697696978', 'p', 'siswa', 'indonesia', 'https://drive.google.com/uc?export=view&id=1ovbjHCLSon5_eFrrwHDD_qpiWI9Y3je_'),
(11, 2, '21221017', '63-8a-8-fe-1f', 1, 'IDA NURMALASARI', '697696978', 'p', 'siswa', 'indonesia', 'https://drive.google.com/uc?export=view&id=1dqN4-82ijdx9R5U3EBJJsMpc2CKlIKGX'),
(12, 2, '21221018', '83-6-6-fe-7d', 1, 'IQNA NALUL MUNA AZHAR NURHALIZ', '697696978', 'p', 'siswa', 'indonesia', 'https://drive.google.com/uc?export=view&id=1fadhv_CIMCwU6m3q8C4BtcFnRzGoqZHn'),
(13, 2, '21221019', 'd3-99-12-fe-a6', 1, 'NADA AULIA PUTRI GUNAWAN', '697696978', 'p', 'siswa', 'indonesia', 'https://drive.google.com/uc?export=view&id=1IJtWxOhtd6BX8P6bzSB9Ml5VulIR198R'),
(14, 2, '21221020', 'f3-2b-19-fe-3f', 1, 'NIDA NURUL FALAAH', '697696978', 'p', 'siswa', 'indonesia', 'https://drive.google.com/uc?export=view&id=1uTI4eSfnxm0I_vXUPqo2M_Xk4chc_PPw'),
(15, 2, '21221021', '13-89-25-fe-41', 1, 'NINING RATNANINGSIH', '697696978', 'p', 'siswa', 'indonesia', 'https://drive.google.com/uc?export=view&id=1VR-siXWG26VvcBMBzjfowyq46uF72N3B'),
(16, 2, '21221022', '53-16-1a-fe-a1', 1, 'NITA KURNIA HAYATI', '697696978', 'p', 'siswa', 'indonesia', 'https://drive.google.com/uc?export=view&id=1PPnWDbDJc4tA807GPZrDitcqXe4DA0v5'),
(17, 2, '21221023', '53-52-b-fe-f4', 1, 'NURAILA AMBARWATI', '697696978', 'p', 'siswa', 'indonesia', 'https://drive.google.com/uc?export=view&id=1eZnRWX7nuSnBVnw7Kb2NQVw5ZGa8ZAD3'),
(18, 2, '21221024', '83-10-1b-fe-76', 1, 'RATNASARI SOPIYANTI', '697696978', 'p', 'siswa', 'indonesia', 'https://drive.google.com/uc?export=view&id=1YTIZiux6dyWdGQX8uymINGJpnyhfyWUW'),
(19, 2, '21221025', 'd3-fc-19-fe-c8', 1, 'RENI SELVI RIFTINA', '697696978', 'p', 'siswa', 'indonesia', 'https://drive.google.com/uc?export=view&id=1PDMsrC5xk9iIvOknJHh1-5siY0EkOf3o'),
(20, 2, '21221026', '43-a6-1b-fe-0', 1, 'RENISA INDINAILA', '697696978', 'p', 'siswa', 'indonesia', 'https://drive.google.com/uc?export=view&id=1KrI-Zbh7bf6LZHpRUKixXFbU8YuAFtLF'),
(21, 2, '21221027', 'a0-cd-f4-73-ea', 1, 'RENITA SEPTIANA', '697696978', 'p', 'siswa', 'indonesia', 'https://drive.google.com/uc?export=view&id=13xVLAGIJPMGCWRW-VoMyyo2lp66kQHjQ'),
(22, 2, '000090909090', '0-75-f5-73-f3', 1, 'RESVIANI CLAUDIA', '697696978', 'p', 'siswa', 'indonesia', 'https://drive.google.com/uc?export=view&id=1tITiKHK3mkuzf16b7pSUIoGNgCFHLmoB'),
(23, 2, '21221029', 'b0-cd-f4-73-fa', 1, 'REVA AULIA', '697696978', 'p', 'siswa', 'indonesia', 'https://drive.google.com/uc?export=view&id=1ANNkm0Fm2alOxeEG1I2U7FLVuGCySA9E'),
(24, 2, '21221030', 'd0-ee-f8-73-b5', 1, 'SILVI OKTAVIA', '697696978', 'p', 'siswa', 'indonesia', 'https://drive.google.com/uc?export=view&id=1v_nAaL_AGBsyN0P13PClImuPox3c3-8h'),
(25, 2, '21221031', 'b0-cd-f4-73-fa', 1, 'SILVI OKTAVIA', '697696978', 'p', 'siswa', 'indonesia', 'https://drive.google.com/uc?export=view&id=1_-_J4x7dIlcBxqRiR_DBYFeQg819gpRp'),
(26, 2, NULL, 'b0-cd-f4-73-fa', 1, '00000000', '697696978', 'p', 'siswa', 'indonesia', 'https://drive.google.com/uc?export=view&id=1_-_J4x7dIlcBxqRiR_DBYFeQg819gpRp');
...
--
ALTER TABLE `absensi`
  MODIFY `id_absensi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=120;

--
-- AUTO_INCREMENT for table `histori`
--
ALTER TABLE `histori`
  MODIFY `id_histori` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=94;
