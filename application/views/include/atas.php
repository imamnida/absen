...
<a class="nav-link nav-icon" href="<?=base_url();?>admin/setting">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link <?php if($this->uri->segment(2)=="dashboard"){echo 'active';}?> collapsed" href="<?=base_url();?>admin/dashboard">
      ...
      <li class="nav-item">
        <a class="nav-link  <?php if($this->uri->segment(2)=="list_users"){echo 'active';}?> collapsed" href="<?=base_url();?>admin/list_users">
      ...
      <li class="nav-item">
        <a class="nav-link <?php if($this->uri->segment(2)=="devices"){echo 'active';}?>  collapsed" href="<?=base_url();?>admin/devices">
      ...
      <li class="nav-item">
        <a class="nav-link  <?php if($this->uri->segment(2)=="kelas"){echo 'active';}?> collapsed" href="<?=base_url();?>admin/kelas">
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content collapse <?php if($this->uri->segment(2)=="rfid"){echo 'show';}?>" data-bs-parent="#sidebar-nav">
          <li>
            <a class="<?php if($this->uri->segment(3)=="rfidnew"){echo 'active';}?>" href="<?=base_url();?>admin/rfid/rfidnew">
              <i class="bi bi-circle"></i><span>RFID NEW</span>
            </a>
          </li>
          <li>
            <a class="<?php if($this->uri->segment(3)=="datarfid"){echo 'active';}?>" href="<?=base_url();?>admin/rfid/datarfid">
      ...
      <li class="nav-item">
        <a class="nav-link <?php if($this->uri->segment(2)=="absensi"){echo 'active';}?> collapsed" href="<?=base_url();?>admin/absensi">
      ...
      <li class="nav-item">
        <a class="nav-link  <?php if($this->uri->segment(2)=="histori"){echo 'active';}?>  collapsed" href="<?=base_url();?>admin/histori">
