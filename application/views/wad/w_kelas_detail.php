                ...
                <div class="card m-b-30">
                    <div class="card-body">
                        <div class="d-flex">
                            ...
                            <a class="ml-auto" href="<?= base_url() ?>/wad/rekap_absen/<?= $kelas->id; ?>"><button class="btn btn-primary">Rekap Absen</button></a>
                        </div>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td style="min-width:100px;">
                                                <a href="<?= base_url() ?>/wad/detail_murid/<?= $row->id_rfid ?>" class="btn btn-success btn-sm"><i class="fa fa-eye"></i></a>
