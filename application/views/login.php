...
<head>
  ...
  <!-- Favicons -->
  <link href="<?=base_url();?>imam/<?=base_url();?>imam/assets/img/favicon.png" rel="icon">
  <link href="<?=base_url();?>imam/assets/img/logo.png" rel="apple-touch-icon">
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form action="<?=base_url();?>login/logincheck" method="post" class="row g-3 needs-validation" novalidate>
              ...
              <div class="credits">
                ...
                Designed by <a href="https://smkn1talaga.sch.id">Kesiswaan SMKN 1 Talaga Majalengka</a>
              </div>
